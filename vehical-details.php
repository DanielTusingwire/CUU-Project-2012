...
<section id="listing_img_slider">
  <div class="listing">
  <div><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="list" width="1000px"  style="margin-left: 45%"  ></div>
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>UGX<?php echo htmlentities($result->PricePerDay);?> </p>Per Day
