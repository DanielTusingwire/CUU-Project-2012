      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1 class="h-banner" >Drive it as if you own it!</h1>
            <p class="p-banner">Best Online Car rental Services in Uganda. Enjoy the best and affordable price ever!</p>
            </div>
        </div>
      </div>
    </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Available Vehicals for you to select</h2>
...
<span class="price">UGX<?php echo htmlentities($result->PricePerDay);?> /Day</span> 
</div>
